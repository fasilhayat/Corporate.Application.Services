...
public sealed class ServiceFactory<TService> : IDisposable
{
    private readonly HttpClient _httpClient;
    private readonly ILogger<TService> _logger;
    private readonly IConfiguration _configuration;
    private readonly string _baseAddress = "https://openlibrary.org/api/books";
    ...
    public async Task<TResult> GetResultAsync<TResult>(IEnumerable<KeyValuePair<string, string>> parameters) where TResult : class, new()
    {
        ...
        try
        {
            ...
            var result = await _httpClient.GetFromJsonAsync<TResult>(fullUrl,
